...
if(isset($_POST['save']))
{
  $survey_id = $_SESSION['survey_id'];
   ...
   if($vraag1 and $vraag2 and $vraag3 and $vraag4 and $vraag5 and $vraag6 > 0){
	 $sql_query = "INSERT INTO fenomeen (answer_id, survey_id, vraag1, vraag2, vraag3, vraag4, vraag5, vraag6, beschrijving)
	 VALUES ('','$survey_id','$vraag1', '$vraag2', '$vraag3', '$vraag4', '$vraag5', '$vraag6', '$text')";

	 if (mysqli_query($con, $sql_query)) 
	 {
		echo "New Details Entry inserted successfully !";
    header("Location: 4_Onderzoeksvaardigheden.php");
	 } 
	 else
     {
...
<body>
    ...
    <!-- Header Start -->
    <form action="3_Fenomeen.php" method="post">
    <div class="progress">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">3</th>
      <td>Kwalitatief en kwantitatief onderzoek</td>
      <td><fieldset class="optGroup">
    ...
    <tr>
      <th scope="row">4</th>
      <td>Validiteit en betrouwbaarheid</td>
      <td ><fieldset class="optGroup">
    ...
    <tr>
      <th scope="row">5</th>
      <td>Ethische aspecten bij onderzoek</td>
      <td><fieldset class="optGroup">
    ...
    <tr>
      <th scope="row">6</th>
      <td>Ontwerponderzoek, vergelijkend onderzoek, evaluerend onderzoek,<br>

literatuuronderzoek, interventie-onderzoek en actie-onderzoek</td>
      <td><fieldset class="optGroup">
